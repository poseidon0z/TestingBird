...
const submitScore = async (username, score) => {
  try {
    ...
    // });
    console.log('Not fetching, test version');
  ...
  return (
    <div className="h-screen w-screen font-postNoBills overflow-hidden bg-signin-bg bg-cover bg-center bg-no-repeat flex flex-col justify-between">
      <div className="relative flex flex-col items-center">
        <img
          src={Note}
          className="z-[10] absolute w-[400px] md:w-[500px] lg:w-[650px] top-0 md:top-0 lg:-top-20"
        />
        <div className="z-[20] absolute text-center pt-[80px] custom-xs:pt-[100px] md:pt-[120px] lg:pt-20 ">
          <p className="font-fonts text-[25px] custom-xs:text-[35px] md:text-[40px] lg:text-[45px] text-white">
      ...
      <div className="relative flex justify-center items-center h-screen bottom-0">
        <img
          src={signb}
          className="absolute z-[10] bottom-0 md:top-[335px] w-[350px] md:w-[400px] lg:w-[400px] h-[390px] md:h-[440px] lg:h-[440px]"
          alt="Signboard"
        />
