...
const LeaderBoard = ({ stayAnonymous, isLoggedIn }) => {
  ...
  return (
    <div className="body leaderboard-bg m-0 p-0 overflow-x-hidden bg-cover bg-no-repeat lg:bg-[100%_100%] flex justify-center items-center min-h-screen w-full">
      <div className="body leaderboard-bg m-0 overflow-x-visible hidden lg:flex items-center flex-col p-6 rounded-3xl shadow-lg out bg-contain bg-no-repeat bg-center box-border max-w-[100%] w-[100%] mx-auto min-h-screen big">
        <div className="flex items-center t1 mt-[-30px]">
          ...
          />
          <h2 className="text-2xl font-bold p-3 text-center lead rounded-custom text-custom-large tracking-wider mt-16 font-postNoBills bg-[#DCC131] pl-[80px] pr-[80px] pb-[23px] pt-[28px]">
            LEADERBOARD
          </h2>
          <img
            src={bird}
        ...
        <ul className="list-none p-0 w-full">
          <div className="flex justify-center gap-20">
            {playersData[2] && (
              <li className="flex flex-col items-center justify-between py-2 border-b last:border-b-0 px-6 mb-4 top-three-item r3 w-180px border border-black tracking-custom-spacing h-150px mt-130px rounded-[15px_50px_50px] bg-[#862220] relative">
            ...
            {playersData[1] && (
              <li className="flex flex-col items-center justify-between py-2 border-b last:border-b-0 px-6 mb-4 bg-silver top-three-item w-200px h-150px mt-110px border border-black tracking-1px bg-[silver] relative rounded-[15px_50px_50px_50px]">
                <span className="font-bold relative text-center min-w-[70px]">
                  <img
                    src={crownSilver}
                    alt="Crown"
      ...
      <div className="flex lg:hidden items-center flex-col rounded-3xl shadow-lg out bg-contain bg-no-repeat box-border max-w-[100%] w-[100%] mx-auto min-h-screen bg-center bg-origin-content-box m-0 p-5">
            ...
            {playersData[2] && (
              <li className="flex flex-col items-center justify-between border-b last:border-b-0 rounded-3xl top-three-item rounded-tl-custom-tl rounded-br-custom-br-tr rounded-tr-custom-br-tr rounded-bl-custom-bl border border-black tracking-custom-spacing bg-[#862220] w-[30%] mt-[65px] p-[3px] text-white relative">
                <img
                  src={crownBronze}
                  alt="Crown"
                  className="absolute h-auto translate-x-[-50%] translate-y-[-50%] mt-[10px] ml-[10px] w-[50px] top-[-10px] left-[-10px]"
                />
            ...
            {playersData[1] && (
              <li className="flex flex-col items-center justify-between border-b last:border-b-0 rounded-3xl top-three-item rounded-tl-custom-tl rounded-br-custom-br-tr rounded-tr-custom-br-tr rounded-bl-custom-bl border border-black tracking-custom-spacing bg-[silver] w-[40%] mt-[45px] p-[3px] relative">
                <img
                  src={crownSilver}
                  alt="Crown"
                  className="absolute w-16 h-auto translate-x-[-50%] translate-y-[-50%] mt-[10px] ml-[10px] top-[-10px] left-[-10px]"
                />
